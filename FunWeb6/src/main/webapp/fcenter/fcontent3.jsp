...
List<BoardBean> boardList=bdao2.guestgetBoardList(startRow, pageSize);
// bdao2.guestgetBoard(num);
...
<div id="wrap">
	...
	<div id="writeReplyForm">
		<form name="replyInfo" target="replyForm">
			...
			<br>
			<input type="button" value="등록" id="replyInsert" onclick="location.href='fcontent.jsp?num=<%=bb.getNum()%>'">
