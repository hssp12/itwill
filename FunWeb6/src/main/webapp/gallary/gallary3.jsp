...
<!-- 본문들어가는 곳 -->
  <!-- 본문 메인 이미지 -->
  <div id="sub_img_center"><img src="../images/room.jpg"></div>
  <!-- 왼쪽 메뉴 -->
  <nav id="sub_menu">
  	<ul>
  		...
  		<li><a href="../gallary/gallary.jsp">Gallary</a></li>
  	</ul>
  </nav>
  <!-- 본문 내용 -->
  <%
  		...
  		<tr><th class="tno">No.</th>
  		  ...
  		  for(int i=0;i<boardList.size();i++){
  	    	...
  	    	%><tr><td><%=bb.getNum() %>
  	    	      ...
  	    	      <td>
  	    	      <img src="../upload/<%=bb.getFile()%>" width="200" height="150"><br><a href="gcontent.jsp?num=<%=bb.getNum()%>">
  	    	      <%=bb.getSubject() %></a></td>
  	    	      <td><%=bb.getName() %></td>
  	              <td><%=bb.getDate() %></td>
